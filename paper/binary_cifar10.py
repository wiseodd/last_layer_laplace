...
class1, class2 = 5, 3
train_loader = dl.binary_CIFAR10(class1, class2, train=True, augm_flag=False)
...
if args.generate_histograms:
    plot_histogram([conf_in, conf_svhn, conf_farway], ['In - CIFAR10', 'Out - SVHN', 'Out - FarAway'], 'hist_confs_cifar10_binary_map')
...
if args.generate_histograms:
    plot_histogram([conf_in, conf_svhn, conf_farway], ['In - CIFAR10', 'Out - SVHN', 'Out - FarAway'], 'hist_confs_cifar10_binary_temp')
...
if args.generate_histograms:
    plot_histogram([conf_in, conf_svhn, conf_farway], ['In - CIFAR10', 'Out - SVHN', 'Out - FarAway'], 'confs_cifar10_binary_llla')
...
if args.generate_figures:
    ...
    plot_conf(confs_map, 'figs/conf_map_cifar10_binary', 'Conf. (MAP)')
    plot_conf(confs_temp, 'figs/conf_temp_cifar10_binary', 'Conf. (Temp.)')
    plot_conf(confs_laplace, 'figs/conf_laplace_cifar10_binary', 'Conf. (LLLA)')
...
with open(f'results/binary/tab_ood_cifar10_{args.randseed}.pkl', 'wb') as f:
    pickle.dump(tab_ood, f)

with open(f'results/binary/tab_cal_cifar10_{args.randseed}.pkl', 'wb') as f:
